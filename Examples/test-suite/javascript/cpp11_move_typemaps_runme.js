...
/* await */(cpp11_move_typemaps.Counter.reset_counts());
var mo2 = new cpp11_move_typemaps.MovableCopyable(111);
/* await */(cpp11_move_typemaps.Counter.check_counts(1, 0, 0, 0, 0, 0));
/* await */(cpp11_move_typemaps.MovableCopyable.take(mo2));
/* await */(cpp11_move_typemaps.Counter.check_counts(1, 0, 0, 1, 0, 2));
/* await */(cpp11_move_typemaps.Counter.check_counts(1, 0, 0, 1, 0, 2));

var mo3 = new cpp11_move_typemaps.MoveOnly(222);
/* await */(cpp11_move_typemaps.MoveOnly.take(mo3));
...
var mo4 = new cpp11_move_typemaps.MoveOnly(333);
/* await */(cpp11_move_typemaps.Counter.check_counts(1, 0, 0, 0, 0, 0));
/* await */(imt.instance_take_move_only(mo4));
/* await */(cpp11_move_typemaps.Counter.check_counts(1, 0, 0, 1, 0, 2));
//delete mo;
