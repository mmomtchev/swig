...
/* await */((cpp11_move_only.Counter.reset_counts()));
var mo2 = /* await */(cpp11_move_only.MovableCopyable.create());
/* await */((cpp11_move_only.Counter.check_counts(2, 1, 0, 0, 1, 2)));

// Move semantics not used
/* await */(cpp11_move_only.Counter.reset_counts());
var mo3 = /* await */(cpp11_move_only.MovableCopyable.createConst());
...
/* await */(cpp11_move_only.Counter.reset_counts());
var mc2 = new cpp11_move_only.MovableCopyable(333);
/* await */(cpp11_move_only.Counter.check_counts(1, 0, 0, 0, 0, 0));
/* await */(cpp11_move_only.global_take_movable_copyable(mc2));
/* await */(cpp11_move_only.Counter.check_counts(2, 0, 1, 1, 0, 2));

// Input instance method
/* await */(cpp11_move_only.Counter.reset_counts());
var imt = new cpp11_move_only.InstanceMethodsTester();
var mc3 = new cpp11_move_only.MovableCopyable(444);
/* await */(cpp11_move_only.Counter.check_counts(1, 0, 0, 0, 0, 0));
/* await */(imt.instance_take_movable_copyable(mc3));
/* await */(cpp11_move_only.Counter.check_counts(2, 0, 1, 1, 0, 2));

// Input constructor
/* await */(cpp11_move_only.Counter.reset_counts());
var mc4 = new cpp11_move_only.MovableCopyable(555);
/* await */(cpp11_move_only.Counter.check_counts(1, 0, 0, 0, 0, 0));
var ct = new cpp11_move_only.ConstructorTester(mc4);
/* await */(cpp11_move_only.Counter.check_counts(2, 0, 1, 1, 0, 2));
